...
public class PSquare implements IShape {
    ...
    public PSquare(double x, double y, double width, double height, double opacity, double strokeWdith) {
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        PCircle newCircle = new PCircle();
        newCircle.setProperties(getProperties());
        newCircle.setBackColor(getBackColor());
        newCircle.setStrokeColor(getStrokeColor());
