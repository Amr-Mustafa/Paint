...
public class PHexagon implements IShape {

    private Map<String, Double> properties;
    private Color backColor;
    private Color strokeColor;

    public PHexagon(double x, double y, double width, double height, double opacity, double strokeWdith) {
    ...
    public void draw(Object canvas) {
        ...
        graphicsContext.fillPolygon(
                new double[]{properties.get("x"),
                        properties.get("x")+(properties.get("height")*0.866),
                        properties.get("x")+(properties.get("height")*0.866),
                        properties.get("x"),
                        properties.get("x")-(properties.get("height")*0.866),
                        properties.get("x")-(properties.get("height")*0.866)},
                ...
                new double[]{properties.get("y")-properties.get("height"),
                        properties.get("y")-(properties.get("height")*0.5),
                        properties.get("y")+(properties.get("height")*0.5),
